...
@ cdecl wined3d_texture_export_shared_handle(ptr ptr ptr)
@ cdecl wined3d_texture_enable_sharing(ptr)
@ cdecl wined3d_texture_import_shared_handle(ptr ptr)
@ cdecl wined3d_texture_publish_shared(ptr ptr)
