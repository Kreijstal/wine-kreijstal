...
**Примечание об этом форке**: Этот репозиторий является личным форком Wine. Сообщайте об ошибках и отправляйте pull request для этого форка на https://github.com/Kreijstal/wine-kreijstal/issues и https://github.com/Kreijstal/wine-kreijstal/pulls . Не сообщайте upstream Wine об ошибках, вызванных этим форком или его дополнительными патчами.
